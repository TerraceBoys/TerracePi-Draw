...
def main(matrix, game_state):
    ...
    drawBatting(game_state.batting)
    drawDiamond()
    drawBases(game_state.base1, game_state.base2, game_state.base3)
    drawInning(str(game_state.inning), game_state.batting)
    drawStrikes(game_state.strikes)
    drawOuts(game_state.outs)
    matrix.Clear()
